...
Service via to serve notifications to the end user.
...
class NotificationService {
  ...
  /// how to schedule a notif
  static Future<int?> scheduleNotification(
      DateTime selectedTime, String title, String body) async {
    ...
    /// specific implement in a different app - may need to remove
